...
|---|---|---|
| **[Agent-Builder](https://github.com/ssevera1/Agent-Builder)** | Design, test, and deploy AI agents against any LLM provider. CLI-first TypeScript monorepo. | 6 providers behind one interface, 5 agent patterns, DAG workflows, and an evaluation framework. Calling a model is easy. Making runs comparable across providers is the actual work. MCP compatible. |
...
- **[GraphRAG-Compliance-Navigator](https://github.com/ssevera1/GraphRAG-Compliance-Navigator):** extracts compliance entities from legal text into a Neo4j knowledge graph, retrieved via hybrid vector and graph search
...
**Data:** Neo4j, vector and graph hybrid retrieval, Streamlit
